...
prepare_vintage <- function(vintage, sample_start = c("1991-04-01"), K = 30, 
  ...
  # topic_type: topics or adjusted topics, "topics", "topics_BPW", or "topics_uncertainty", "topics_BCC", or "topics_sentiws"
  ...
  #list_topics_select <- c("T45", "T78", "T139", "T83", "T9", "T134", "T84",
  #                        "T82", "T155", "T142")
  
  # 10 most correlated and meaningful topics (Investment, <2008, non-adjusted)
  #list_topics_select <- c("T150", "T50", "T134", "T29", "T110", "T59", "T21",
  #                        "T23", "T108", "T120")
  ...
  #list_topics_select <- c("T78", "T155", "T134", "T139", "T183", "T142", "T178",
  #                        "T83", "T45", "T167")
  
  # 10 most correlated and meaningful sentiment-adjusted topics (BPW) (Investment, <2008, sentiment-adjusted, BPW)
  #list_topics_select <- c("T112", "T150", "T167", "T154", "T183", "T50", "T120",
  #                        "T21", "T29", "T9")
  ...
  #list_topics_select <- c("T73", "T102", "T58", "T191", "T180", "T147", "T81",
  #                        "T59", "T54", "T45")
  
  # 10 most correlated and meaningful sign-adjusted topics (BCC) (Investment, <2010, sign-adjusted, BCC)
  #list_topics_select <- c("T27", "T138", "T81", "T48", "T52", "T168", "T127",
  #                        "T63", "T74", "T118")
  ...
  # 10 sentiment-adjusted topics (SentiWS, 200 topics) most correlated with Investment (Investment, <2008, sentiment-adjusted)
  #list_topics_select <- c("T50", "T21", "T29", "T134", "T120", "T38", "T108",
  #                        "T182", "T23", "T91")
  
  # 10 uncertainty-adjusted topics (200 topics) most correlated with Investment (Investment, <2008, uncertainty-adjusted)
  #list_topics_select <- c("T134", "T59", "T123", "T154", "T9",
  #                        "T23", "T18", "T21", "T50", "T7") 
  
  # 10 sentiment-adjusted topics (SentiWS, 200 topics) most correlated with Consumption (Consumption, <2008, sentiment-adjusted)
  #list_topics_select <- c("T78", "T45", "T83", "T9", "T13", "T14", "T142",
  #                        "T134", "T147", "T75")
  
  # 10 uncertainty-adjusted topics (200 topics) most correlated with Consumption (Consumption, <2008, uncertainty-adjusted)
  list_topics_select <- c("T78", "T134", "T100", "T117", "T45", "T38", "T194",
                          "T46", "T1", "T131")
  ...
  directory_name <- paste0("./vintages_monthly_", forecast_var, "_", topic_type, "_", 
                           estimation_period, "_", num_topics, "_", source, selected, "_update")
